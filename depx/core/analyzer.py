...
class DependencyAnalyzer:
    ...
    def _find_duplicate_dependencies(self, projects: List[ProjectInfo]) -> Dict[str, Any]:
        """查找重复的依赖"""
    ...
    def _generate_cleanup_suggestions(self, projects: List[ProjectInfo]) -> List[Dict[str, Any]]:
        """生成清理建议"""
        suggestions = []
        ...
        for project in projects:
            dev_dep_size = sum(
                dep.size_bytes for dep in project.dependencies 
    ...
    def _empty_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "duplicate_dependencies": {"count": 0, "dependencies": [], "total_potential_savings": 0},
            "cleanup_suggestions": []
        }
